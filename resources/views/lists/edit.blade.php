<x-app-layout>
    <h1 class="flex justify-center text-4xl font-bold text-gray-900 shadow-md py-4">Update Listing</h1>
    <div class="max-w-7xl py-2 mx-auto flex justify-center text-gray-800 ">
        ...
        @foreach ($listings as $listing)
            <form action="{{ route('listing.update', $listing->id) }}" method="POST"
                class="py-4 border border-solid-gray-900 shadow-xl">
                @csrf
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-3/4">
                        ...
                        <input type="text" id="place_name" name="place_name" value="{{ $listing['place_name'] }}"
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-3/4">
                        <label for="place_description"
                            class="block text-lg font-semibold text-navy-700">Description</label>
                        <textarea id="place_description" name="place_description"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                            rows="4">{{ $listing['place_description'] }}</textarea>
                    </div>
                </div>
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-3/4">
                        ...
                        <select id="place_type" name="place_type"
                            ...
                            <!-- This disables the first "Select a type" option to force a selection -->
                            <option value="" disabled>Select a type</option>

                            <!-- Use ternary operators to check if the database value matches the option value -->
                            <option value="dorm" {{ $listing->place_type === 'dorm' ? 'selected' : '' }}>Dorm</option>
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-3/4">
                        <label for="place_brgy_street" class="block text-lg font-semibold text-navy-700">Located
                            At</label>
                        <input type="text" id="place_region" name="place_region"
                            value="{{ $listing['place_region'] }}"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                            placeholder="Region">
                        <input type="text" id="place_brgy_street" name="place_brgy_street"
                            value="{{ $listing['place_brgy_street'] }}"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                            placeholder="Street">
                        <input type="text" id="place_municipality_town" name="place_municipality_town"
                            value="{{ $listing['place_municipality_town'] }}"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                            placeholder="Town">
                        <input type="text" id="place_province_city" name="place_province_city"
                            value="{{ $listing['place_province_city'] }}"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-3/4">
                        ...
                        <input type="text" id="place_contact_num" name="place_contact_num"
                            value="{{ $listing['place_contact_num'] }}"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                </div>
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-3/4">
                        ...
                        <input type="email" id="place_email" name="place_email" value="{{ $listing['place_email'] }}"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                </div>
                ...
                <div class="mb-6 flex justify-center">
                    <div class="w-3/4">
                        ...
                        <input type="number" id="place_monthly_rent" name="place_monthly_rent"
                            value="{{ $listing['place_monthly_rent'] }}"
                            class="w-full mt-1 px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                    </div>
                </div>
